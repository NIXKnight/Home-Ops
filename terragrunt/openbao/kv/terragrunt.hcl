...
locals {
  # KV unit config (engine mounts, ESO mount, policy/role/SA names, audience) lives in the
  # Internal repo as HCL -- same mechanism the kubernetes-auth and argocd units use.
