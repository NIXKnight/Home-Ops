...
| `3`  | `new-api` (parallel OpenAI-compatible gateway pilot; shared PostgreSQL, ESO-backed runtime configuration, and private raw workload manifests; no public exposure at bootstrap) |
